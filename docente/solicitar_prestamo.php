...
<head>
    ...
    <style>
        /* Estilos resumidos para contenedor y formulario */
...
<div class="container">
    ...
    <?php if ($mensaje): ?>
        ...
        <?php if ($tipoMensaje === 'exito'): ?>
            <div style="text-align: center;">
                <a href="mis_prestamos.php" class="btn btn-primary"><i class="fas fa-bookmark"></i> Ver Mis Préstamos</a>
                <a href="catalogo.php" class="btn btn-secondary"><i class="fas fa-book"></i> Ir al Catálogo</a>
            </div>
        <?php endif; ?>
    <?php endif; ?>

    <?php
    if ($libroSeleccionado && !$mensaje):
    ?>
        <!-- Previsualización del libro seleccionado -->
        ...
        <div class="formulario">
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    <label for="dias_prestamo"><i class="fas fa-calendar-alt"></i> Duración del Préstamo</label>
                ...
                <div class="btn-group">
                    ...
                    <a href="catalogo.php" class="btn btn-secondary"><i class="fas fa-times"></i> Cancelar</a>
                </div>
            </form>
        </div>
    ...
    <?php elseif (!$mensaje): ?>
        ...
        <div class="formulario">
            ...
            <div class="form-group">
                <label for="libro_select"><i class="fas fa-book"></i> Libro Disponible</label>
            ...
            <div style="text-align: center; margin-top: 15px;">
                <a href="catalogo.php" class="btn btn-primary"><i class="fas fa-book"></i> Ir al Catálogo</a>
            </div>
        </div>
    <?php endif; ?>
</div>
