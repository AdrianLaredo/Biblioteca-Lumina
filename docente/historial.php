...
$prestamosDevueltos = count(array_filter($historial, function($p) { return $p['estado'] === 'Devuelto'; }));
$prestamosActivos = count(array_filter($historial, function($p) { return $p['estado'] === 'Activo'; }));
$prestamosAtrasados = count(array_filter($historial, function($p) { return $p['estado'] === 'Atrasado'; }));
?>
        ...
        <?php if ($totalPrestamos > 0): ?>
            ...
            <div class="estadisticas">
                <div class="stat-card total">
                    ...
                    <div class="stat-numero"><?php echo $totalPrestamos; ?></div>
                    <div class="stat-label">Total Préstamos</div>
                </div>

                <div class="stat-card activos">
                    <i class="fas fa-bookmark"></i>
                    <div class="stat-numero"><?php echo $prestamosActivos; ?></div>
                    <div class="stat-label">Activos</div>
                </div>

                <div class="stat-card devueltos">
                    <i class="fas fa-check-circle"></i>
                    <div class="stat-numero"><?php echo $prestamosDevueltos; ?></div>
                    <div class="stat-label">Devueltos</div>
                </div>

                <div class="stat-card atrasados">
                    <i class="fas fa-exclamation-triangle"></i>
                    <div class="stat-numero"><?php echo $prestamosAtrasados; ?></div>
            ...
            <div class="tabla-container">
                ...
                <img src="<?php echo htmlspecialchars($prestamo['portada'] ?: 'portada/no portada.png'); ?>"
                     ...
                     onerror="this.src='portada/no portada.png'">
                                        <?php else: ?>
                                            <img src="https://via.placeholder.com/50x70?text=No" alt="Sin portada">
                                        <?php endif; ?>
                                ...
                                <td>
                                    <span class="badge <?php echo strtolower($prestamo['estado']); ?>">
